...
const CreateUser = ({ session, user }: PropType) => {
  const pathName = usePathname();
  const [selectedImage, setSelectedImage] = useState<string[]>([user?.profile_picture_url||'']);
  ...
  return (
    <Container center className="min-h-dvh bg-white-1 w-full px-5">
      ...
      >
        ...
        <Input defaultValue={user?.location} name="location" min={2} required maxLength={150} />
